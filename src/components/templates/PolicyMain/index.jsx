    ...
    return (
        <div className="w-full max-w-[1500px] bg-white mx-auto p-4 md:p-16 m-16">
            ...
            <div className="flex flex-col gap-4 my-8 text-color_text_black">
                ...
                <p className="text-s1_7 text-left mt-4">
                ...
                <p className="text-s1_7 text-left mt-4">
                    C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do Tem Sabor, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.
                    Mais informações
