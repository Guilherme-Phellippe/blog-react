...
export const Singup = () => {
    ...
    return (
        <div className="w-full bg-white p-4">
            <h2 className="text-center font-bold text-s2 text-color_second p-4">Crie uma conta rápido e fácil</h2>
            <div className="w-full flex justify-center">
                <form className="w-5/6 flex flex-col items-center" action="">
                    ...
                    <Button customClass={'btn-primary px-16 mt-8 flex justify-center items-center gap-2 text-s1_2'}>
