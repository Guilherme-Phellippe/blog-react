        ...
        <div className="w-full p-4 flex flex-wrap justify-center gap-4">
            {recipes.map(recipe =>
                <ListRecipes
                    key={recipe.id}
                    recipe={recipe}
                    classContainer='w-[15rem] md:w-[23rem] h-[15rem] border-[1px] overflow-hidden rounded-2xl relative border-solid cursor-pointer transition-transform hover:scale-105 hover:border-color_red'
