export const IngredientsList = ({ ing: ingredients, stuffing_ing }) => {
    return (
        <div className="w-full h-auto flex flex-col items-center p-4 mt-8">
            <h2 className='text-s2 text-color_primary text-center font-bold my-4 bg-color_primary/20 w-full p-4'>INGREDIENTES</h2>
            ...
            </ul>
            {
                !!stuffing_ing.length &&
                <>
                    <h2 className='text-s2 text-color_primary text-center font-bold my-4 bg-color_primary/20 w-full p-4'>RECHEIO</h2>
                    <ul className='w-full p-4 flex flex-col'>
                        {
